...
impl Input {
    pub fn init() -> Self {
        ...
        Self{mouse_wheel, mouse_position, mousebuttons, buttons }
    }
    ...
    pub fn on_mousebutton_pressed(&mut self, mouse_btn: MouseButton) {
        match mouse_btn {
            MouseButton::Unknown => {  },
            _ => { self.mousebuttons.insert(mouse_btn, Keystate::Pressed); }
        }
    }
    pub fn on_mousebutton_released(&mut self, mouse_btn: MouseButton) {
        match mouse_btn {
            MouseButton::Unknown => {  },
            _ => { self.mousebuttons.insert(mouse_btn, Keystate::Released); }
        }
    }
