...
const HASH: [u8; 255] = [208,34,231,213,32,248,233,56,161,78,24,140,71,48,140,254,245,255,247,247,40,
...
fn noise2d(x: f32, y: f32) -> f32 {
    ...
    let s = noise2(x_int, y_int);
    let t = noise2(x_int + 1, y_int);
    let u = noise2(x_int, y_int + 1);
    let v = noise2(x_int + 1, y_int + 1);
