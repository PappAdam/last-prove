use renderer::engine::vector2::{Convert, Vector2};
...
impl Input {
    ...
    pub fn on_mouse_moved(&mut self, new_mouse_position: Vector2<f32>) {
        let relative_new_mouse_position = new_mouse_position - Vector2::new(1f32, 1f32);
